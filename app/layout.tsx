...
export const metadata: Metadata = {
  ...
  description: "Oasis 8 Massage at 7086 El Cajon Blvd, Suite C, La Mesa. Foot, hot stone, deep tissue, and combo work. Open every day, 10 AM to 9:30 PM. Combo: 30 min foot + 30 min body for $45. 10% off active duty and veterans. Walk-ins welcome. Call (619) 548-0773.",
  ...
  openGraph: {
    ...
    description: "An honest hour for everywhere you carry it. Foot, hot stone, deep tissue, combo. Open every day, 10 AM to 9:30 PM at 7086 El Cajon Blvd, Suite C, La Mesa.",
    ...
    <html lang="en" className={`${display.variable} ${sans.variable}`}>
      <body className="bg-cream text-ink antialiased">
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          address: { "@type": "PostalAddress", streetAddress: "7086 El Cajon Blvd, Suite C", addressLocality: "La Mesa", addressRegion: "CA", postalCode: "91942", addressCountry: "US" },
