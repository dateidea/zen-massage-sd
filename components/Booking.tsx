            ...
            <div className="bg-cream p-8 shadow-[0_1px_0_rgba(0,0,0,0.04)] md:p-12">
              {!submitted ? (
                ...
                <div className="flex min-h-[420px] flex-col justify-center">
                  ...
                  <p className="mt-6 max-w-[44ch] text-[16px] text-ink-soft">If you do not hear from us by tomorrow morning, please call <a href="tel:+16194396708" className="link-underline text-ink">(619) 439-6708</a>.</p>
                </div>
              )}
            </div>
          </Reveal>
