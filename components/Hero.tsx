      ...
      <div className="mx-auto w-full max-w-[1320px] px-6 pb-20 pt-40 md:px-10 md:pb-28 md:pt-48">
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 md:col-span-9 lg:col-span-8">
            <p className="eyebrow mb-8 text-cream/70">ZEN Massage &middot; 7086 El Cajon Blvd &middot; San Diego</p>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-6">
              ...
              <a href="tel:+16195480773" className="link-underline text-[14px] tracking-[0.02em] text-cream/85">Or call (619) 548-0773</a>
            </div>
          </div>
        </div>
      </div>
