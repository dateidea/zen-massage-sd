...
export default function Footer() {
  return (
    <footer className="border-t border-hairline bg-shadow text-ink">
      <div className="mx-auto max-w-[1320px] px-6 py-16 md:px-10 md:py-20">
        <div className="grid grid-cols-12 gap-x-6 gap-y-12">
          <div className="col-span-12 md:col-span-5">
            <Logo />
            <p className="mt-6 max-w-[36ch] text-[14px] leading-[1.7] text-ink-soft">A small neighborhood massage studio at 7900 El Cajon Blvd in La Mesa. Hot stones, deep tissue, foot reflexology. Open every day, 10 AM to 9:30 PM. Walk-ins welcome. 10% off active duty and veterans.</p>
            <a href="#booking" className="btn-primary mt-8 inline-flex items-center rounded-none px-6 py-3 text-[12px] tracking-[0.16em] uppercase">Book a session</a>
          </div>
          <div className="col-span-6 md:col-span-2 md:col-start-7">
            <p className="text-[11px] tracking-[0.20em] uppercase text-clay">Visit</p>
            <address className="mt-4 not-italic text-[14px] leading-[1.7] text-ink">7900 El Cajon Blvd<br />Suite C<br />La Mesa, CA 91942</address>
          ...
          <div className="col-span-6 md:col-span-2">
            <p className="text-[11px] tracking-[0.20em] uppercase text-clay">Hours</p>
            <p className="mt-4 text-[14px] leading-[1.7] text-ink">Mon &ndash; Sun<br />10:00 AM &ndash; 9:30 PM</p>
          </div>
          <div className="col-span-12 md:col-span-3">
            <p className="text-[11px] tracking-[0.20em] uppercase text-clay">Reach us</p>
            <a href="tel:+16194396708" className="display mt-3 block text-[28px] leading-none text-ink">(619) 439-6708</a>
