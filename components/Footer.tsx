      ...
      <div className="mx-auto max-w-[1320px] px-6 py-16 md:px-10 md:py-20">
        <div className="grid grid-cols-12 gap-x-6 gap-y-12">
          <div className="col-span-12 md:col-span-5">
            <Logo />
            <p className="mt-6 max-w-[36ch] text-[14px] leading-[1.7] text-ink-soft">A small neighborhood massage studio at 7086 El Cajon Blvd in San Diego. Hot stones, deep tissue, foot reflexology. Open every day, 9:30 AM to 10 PM. Walk-ins welcome. 10% off active duty and veterans.</p>
          ...
          <div className="col-span-6 md:col-span-2 md:col-start-7">
            ...
            <address className="mt-4 not-italic text-[14px] leading-[1.7] text-ink">7086 El Cajon Blvd<br />Suite C<br />San Diego, CA 92115</address>
