      ...
      <div className="mx-auto max-w-[1320px] px-6 py-16 md:px-10 md:py-20">
        <div className="grid grid-cols-12 gap-x-6 gap-y-12">
          <div className="col-span-12 md:col-span-5">
            ...
            <a href="#booking" className="btn-primary mt-8 inline-flex items-center rounded-full px-6 py-3 text-[12px] tracking-[0.05em] uppercase">Book a session</a>
          </div>
          <div className="col-span-6 md:col-span-2 md:col-start-7">
            ...
            <a href="https://maps.app.goo.gl/BzZuUZrvG5NLdQzK6" target="_blank" rel="noreferrer" className="link-underline mt-4 inline-block text-[13px] text-mid">Get directions &rarr;</a>
          </div>
          ...
          <div className="col-span-12 md:col-span-3">
            <p className="text-[12px] tracking-[0.18em] uppercase text-mid">Reach us</p>
