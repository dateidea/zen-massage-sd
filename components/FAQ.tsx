...
const faqs: QA[] = [
  ...
  { q: "Where do I park?", a: (<>Free parking lot directly in front of the studio at 7086 El Cajon Blvd, Suite C, La Mesa, between 78th and 79th Street. We are a five-minute drive from SDSU, on the 1 and 815 bus lines, and just east of the College Area.</>) },
