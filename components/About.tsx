      ...
      <div className="mx-auto max-w-[1320px] px-6 md:px-10">
        <div className="grid grid-cols-12 gap-x-6 gap-y-12">
          ...
          <Reveal delay={120} className="col-span-12 md:col-span-6 md:col-start-7">
            ...
            <h2 id="about-heading" className="display mt-4 text-[40px] leading-[1.05] md:text-[56px]">
              A small neighborhood<br />
              <span className="italic font-light text-ink-soft">massage studio</span><br />
            ...
            <div className="mt-10 grid grid-cols-2 gap-6 border-t border-hairline pt-8 text-[13px]">
              <div><p className="text-mid">Specialties</p><p className="mt-1 text-ink">Hot stone, deep tissue, foot reflexology, couples</p></div>
              <div><p className="text-mid">Hours</p><p className="mt-1 text-ink">Daily, 10 AM &ndash; 9:30 PM</p></div>
              <div><p className="text-mid">Combo deal</p><p className="mt-1 text-ink">$45 &mdash; 30 min foot + 30 min body</p></div>
              <div><p className="text-mid">Military</p><p className="mt-1 text-ink">10% off active duty &amp; veterans</p></div>
            </div>
          </Reveal>
        </div>
      </div>
