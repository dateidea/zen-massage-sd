    ...
    >
      <div className="grid grid-cols-12 items-start gap-x-6 gap-y-12 md:gap-x-12">
        <Reveal className="col-span-12 md:col-span-5">
          <div role="img" aria-label="The treatment room of Navajo Spa — cedar table dressed with neatly folded ivory linen, soft late-afternoon window light"
        ...
        <Reveal delay={120} className="col-span-12 md:col-span-7">
          <div className="space-y-7 text-[17px] leading-[1.85] text-ink-soft">
            <p>Navajo Spa sits at the corner of El Cajon Boulevard and 79th Street in San Diego, two blocks east of the College Area. A small front room with warm decor. Comfortable rooms with crisp white sheets and neatly arranged towels. Hot stones warming on the counter most days.</p>
